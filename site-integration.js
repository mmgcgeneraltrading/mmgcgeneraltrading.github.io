(()=>{
  ...
  const addSmartHomeBanner=()=>{
    ...
    section.innerHTML=`<div class="wrap smart-home-inner"><div><p class="eyebrow">NEW MMGC TECHNOLOGY RANGE</p><h2>Smart Home. Smart Life.</h2><p>MMGC now supplies and installs Starlink, smart security, mesh Wi-Fi, Smart TVs, smart appliances, AI home automation, smart energy and connected-vehicle technology. Start with a complete package or build your own system.</p><div class="smart-home-tags"><span>Starlink & Wi-Fi</span><span>Cameras & Alarms</span><span>Smart TVs</span><span>Lights & Plugs</span><span>AI Home Manager</span><span>Smart Appliances</span><span>Energy</span><span>Smart Vehicle</span></div><div class="smart-home-actions"><a class="btn gold" href="products.html">Browse Smart Home Products</a><a class="btn light-btn" target="_blank" rel="noopener" href="https://wa.me/26658311808?text=Hello%20MMGC%2C%20I%20want%20a%20Smart%20Home%20quotation.">Build My Smart Home</a></div></div><div class="smart-home-pack-preview"><a href="products.html"><b>M15,200</b><span>Secure Start</span></a><a href="products.html"><b>M20,000</b><span>Connected Home</span></a><a href="products.html"><b>M25,000</b><span>Smart Family</span></a><a href="products.html"><b>M30,000</b><span>Smart Home Pro</span></a></div></div>`;
  ...
  const init=()=>{
    ...
    if(nav){
      ...
      if(!products){products=document.createElement('a');products.href='products.html';products.textContent='Smart Home & Products';opp?.insertAdjacentElement('afterend',products);if(!opp)nav.prepend(products);}else products.textContent='Smart Home & Products';
